<?php 
  ...
  $query = "INSERT INTO tb_organizacao 
      (nome_org, id_tipo_org, id_organizacao_pai, tel_fixo_org, tel_cel_org, email_org, 
      CEP_org, id_cidade_org, logradouro_org, num_org, complemento_org, bairro_org) 
      values (:nome_org, :id_tipo_org, :id_organizacao_pai, :tel_fixo_org, :tel_cel_org, :email_org, 
      :CEP_org, :id_cidade_org, :logradouro_org, :num_org, :complemento_org, :bairro_org);";
