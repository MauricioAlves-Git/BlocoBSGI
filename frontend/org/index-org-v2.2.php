...
<!-- index-org-v2.2.php -->
<!-- versao 2.2 - baseado em cadastro_bd_pdo (form-insercao.php) -->
...
<html lang="pt-br">
    ...
    <link href="estilo1-v2.2.css" rel="stylesheet">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
...
<body>
    ...
    <section id="main"> 
        <h1 class="titulo">Cadastro Organizacional   - - - - - - - - - - - - - - - - - - -<span>   Consultar - Incluir - Excluir</span></h1>
        
    <!-- <nav id="crud" class="navbar navbar-expand-sm bg-primary navbar-dark"> -->
    
    <!--
    <nav id="crud" >
        <ul class="titulo">
          <li class="right">   
            <a href="#Consultar">Consultar</a></li>
          <li class="right">
              <a href="#Incluir">Incluir</a></li>
          <li class="right">
              <a href="#Excluir">Excluir</a></li>
        </ul>  -->
	...
	<br>
        <!-- <select id="idTipoOrg"> -->
        <label for="idTipoOrg">    
		<input type="text" name="TipoOrg" placeholder="Tipo da Organização (selecione)" class="form-control mb-1 mr-sm-2">
	<!-- </select> -->
    </div>
    <br>
